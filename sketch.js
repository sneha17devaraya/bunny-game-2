...
function preload()
{
  ...
  stardisplayImage = loadAnimation("empty.png");
  starImage1 = loadAnimation("one_star.png");
  starImage2 = loadAnimation("stars.png")
...
function setup() 
{
  ...
  stardisplay = createSprite(50,30,30,30);
  stardisplay.addAnimation("empty",stardisplayImage);
  stardisplay.addAnimation("star1",starImage1);
  stardisplay.addAnimation("star2",starImage2);
...
function draw() 
{
  ...
  if(collide(fruit,star,20)==true){
    star.visible=false;
    stardisplay.changeAnimation("star1")
  }
  if(collide(fruit,star2,20)==true){
    star2.visible=false;
    stardisplay.changeAnimation("star2")
  }
}
